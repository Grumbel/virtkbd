...
private:
  ...
  uinpp::EventEmitter* m_backspace_key;
  uinpp::EventEmitter* m_shift_key;
  uinpp::EventEmitter* m_ctrl_key;

public:
  KeyboardController(VirtualKeyboard& keyboard, uinpp::MultiDevice& uinput, const std::string& device);
  ~KeyboardController();
